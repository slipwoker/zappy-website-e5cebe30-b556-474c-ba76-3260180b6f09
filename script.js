document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (isRTL) {
            ...
            const scrollLeft = window.pageXOffset + targetRect.left - (window.innerWidth - targetRect.width) / 2;
            window.scrollTo({
                left: scrollLeft,
                behavior: 'smooth'
            });
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('maxlength') && value.length > parseInt(input.getAttribute('maxlength'))) {
                showError(input, `${name} must be no more than ${input.getAttribute('maxlength')} characters`);
                return false;
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e5cebe30-b556-474c-ba76-3260180b6f09',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e5cebe30-b556-474c-ba76-3260180b6f09';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e5cebe30-b556-474c-ba76-3260180b6f09';
